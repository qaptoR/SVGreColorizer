...
const SAVE_AS_TEXT :Dictionary = {
    GE.ColorFormat.HEX: '#RRGGBBAA',
    GE.ColorFormat.RGB_PERC: 'rgba(R%, G%, B%, A)',
    GE.ColorFormat.RGB_INT: 'rgba(rrr, ggg, bbb, aaa)',
    GE.ColorFormat.HSL: 'hsla(h, s%, l%, a)',
    GE.ColorFormat.KEYWORD: 'keyword',
}

const COLOR_KEYWORDS :Dictionary = {
    'aliceblue':         '#f0f8ff',
    'antiquewhite':      '#faebd7',
    'aqua':              '#00ffff',
    'aquamarine':        '#7fffd4',
